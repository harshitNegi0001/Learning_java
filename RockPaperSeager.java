...
public class RockPaperSeager{
	...
	public static char userChoice(){
		...
		if(user.startsWith("r")||user.startsWith("R")){
			...
			System.out.println("You entered Seager");
			return 's';
		}
			...
			System.out.print("Please select from 'stone','paper' or 'seager'");
			return userChoice();
		}
	}
	public static char comChoice(){
		...
		if(rnum<3){
			...
			System.out.println("Computer choosed Seager");
			return 's';
		}
	}
